                        ...
                        <form method="post" action="func2.php">
                            <div class="row register-form">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        <input type="number" minlength="10" maxlength="10" name="contact"
                                            class="form-control" placeholder="Your Phone *" require/>
                                    </div>
                                    <div class="form-group">
                    ...
                    <div class="tab-pane fade show" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                        ...
                        <form method="post" action="func1.php">
                            <div class="row register-form">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <input type="text" class="form-control" placeholder="Email *" name="username3"
                                            onkeydown="return alphaOnly(event);" required />
                                    </div>
                                </div> 
                                <div class="col-md-6">
