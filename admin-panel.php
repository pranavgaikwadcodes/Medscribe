            ...
            <div class="col-md-8" style="margin-top: 3%;">
                <div class="tab-content" id="nav-tabContent" style="width: 950px;">
                  ...
                  ?> -->
                    ...
                    $query = "select ID,doctor,docFees,appdate,apptime,userStatus,doctorStatus,paymentStatus from appointmenttb where fname ='$fname' and lname='$lname';";
                    $result = mysqli_query($con,$query);
                    while ($row = mysqli_fetch_array($result)){
                  ...
                  ?>
                    ...
                    else if( ($row['paymentStatus']==0) && ($row['userStatus']==1) && ($row['doctorStatus']==1))  
                    {
                      echo "<div style='color:blue;'>Active</div>";
                    }
                    else if( ($row['paymentStatus']==0) && ($row['userStatus']==0) && ($row['doctorStatus']==1))  
                    {
                      echo "<div style='color:brown;'>Cancelled by Patient</div>";
                    }

                    else if(($row['paymentStatus']==0) && ($row['userStatus']==1) && ($row['doctorStatus']==0))  
                    {
                    ...
                    if(($row['paymentStatus']==1)){
                      ...
                      echo "Cancelled";
                                    ...
                                    <td style="width: 150px;">
                                        ...
                                        ?>
                                        <form action="checkout/razorpay/razorpay" method="GET">
                                            <input type="hidden" name="amt" value="<?php echo $row['docFees']?>">    
                                            <input type="hidden" name="name" value="<?php echo $username ?>">    
                                            <input type="hidden" name="pid" value="<?php echo $pid ?>">    
                                            <button type="submit" style="width: 120px;" class="btn btn-primary">Pay</button>
                                        </form>
                                        <?php
                                        }?>
                                    </td>
